...
if __name__ == "__main__":
    ...
    type_info_dict = {
        ...
        1: ("tumar", (255, 204, 204)),  # neoplastic
        2: ("stroma", (150,200,150)),  # inflamm
        3: ("immune", (160, 90, 160)),  # connective
        4: ("necros", (50, 50, 50)),  # dead
        5: ("other", (255, 200, 0)),  # non-neoplastic epithelial
    }
