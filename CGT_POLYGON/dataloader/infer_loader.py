...
class SerializeFileList(data.IterableDataset):
    ...
    def __next__(self):
        ...
        feed_dict = {"img": patch_data.astype("uint8")}
        feed_dict["inst_map"] = patch_inst_data.astype("int32")
