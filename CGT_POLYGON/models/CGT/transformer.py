...
class Transformer(nn.Module):
    ...
    def forward(self, src, query_embed, pos_embed, mask=None):
        ...
        bs, c, h, w = src.shape
        src = src.reshape(bs,1,c) 
        #pos_embed = pos_embed.flatten(2).permute(2, 0, 1)
        #print(src.shape,query_embed.shape,pos_embed.shape,mask.shape) 
        ...
        #print(hs.shape,memory.shape)
        return hs.transpose(1, 2).view(bs,c), memory.view(bs,c)
